...
function displayPeriodType() {
  var divisionid = document.getElementById("applicationperiod-divisionid")
    .selectedIndex;
  ...
  if (divisionid == 0) {
    ...
    document.getElementById(
      "applicationperiod-applicationperiodtypeid"
    ).selectedIndex = 0;
    document.getElementById("applicationperiodtypeid-field").style.display =
      "none";

    document.getElementById("application-period-exists-alert").style.display =
      "none";
...
function calculateApplicantIntent(e) {
  ...
  function stateck() {
    if (httpxml.readyState == 4) {
      ...
      if (academicYearExists == 1 && applicationPeriodExists == 1) {
        document.getElementById(
          "application-period-exists-alert"
        ).style.display = "block";
        document.getElementById("new-year-options").style.display = "none";
        document.getElementById("buttons").style.display = "none";
  ...
  var divisionid = document.getElementById("applicationperiod-divisionid")
    .value;
  var applicationperiodtypeid = document.getElementById(
    "applicationperiod-applicationperiodtypeid"
  ).value;
...
function generateAcademicYearBlanks() {
  ...
  if (
    (title == null || title == false || title == " " || title == "") &&
...
function generateAcademicSemesterBlanks() {
  ...
  for (i = 0; i < 3; i++) {
    ...
    if (
      title == "0" && //(title == null || title == false || title == " " || title == "")
      ...
      document.getElementById("semester-" + i + "-startdate").value =
        "1990-01-01";
      document.getElementById("semester-" + i + "-enddate").value =
        "1990-01-01";
    }
  }
}
