...
class ApplicationModel
{
    ...
    public static function isCandidateApplicationUnderConsideration(
        ...
        if ($applicationUnderConsideration == true
    ...
    public static function getProgammeDescription($application)
    {
        ...
        } elseif ($programmeCatalog->qualificationtypeid == true
    ...
    public static function getCurrentOfTwoApplications($applications)
    {
        ...
        } elseif ($applications[0]->applicationstatusid == 3
        && $applications[1]->applicationstatusid == 3) {
            return $applications[0];
        } elseif ($applications[0]->applicationstatusid == 10
        &&  $applications[1]->applicationstatusid == 3) {
            return $applications[1];
        }

        //if shortlisted
        elseif ($applications[0]->applicationstatusid == 4
        &&  $applications[1]->applicationstatusid == 3) {
            return $applications[0];
        } elseif ($applications[0]->applicationstatusid == 6  &&
        ...
        //if borderlined
        elseif ($applications[0]->applicationstatusid == 7
        &&  $applications[1]->applicationstatusid == 3) {
            return $applications[0];
        } elseif ($applications[0]->applicationstatusid == 6
        ...
        //if interview-offer
        elseif ($applications[0]->applicationstatusid == 8
        &&  $applications[1]->applicationstatusid == 6) {
            return $applications[0];
        } elseif ($applications[0]->applicationstatusid == 6
        ...
        //if offer
        elseif ($applications[0]->applicationstatusid == 9
        &&  $applications[1]->applicationstatusid == 6) {
            return $applications[0];
        } elseif ($applications[0]->applicationstatusid == 9
       ...
       &&  $applications[1]->applicationstatusid == 9) {
        ...
        //if abandoned
        elseif ($applications[0]->applicationstatusid == 11
    ...
    public static function getImplicitlyLabelledCurrentApplication(
        ...
        if (self::hasAdminCreatedApplication($verifiedApplications) == true
