                ...
                ?>
                    ...
                    <table class='table table-hover' style='width:100%; margin: 0 auto;'>
                       ...
                       <tr>
                            ...
                            <td><?=$form->field($outline, 'level')->label('')->dropDownList(($levels), ['prompt'=>'Select Course Level']);?></td>
                        </tr>
                        
                        <tr>
                            <th style='width:30%; vertical-align:middle'>Pre-requisites</th>
                            <td><?=$form->field($outline, 'prerequisites')->label('', ['class'=> 'form-label'])->textInput(['maxlength' => true]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Co-requisities</th>
                            <td><?=$form->field($outline, 'corequisites')->label('', ['class'=> 'form-label'])->textInput(['maxlength' => true]);?></td>
                       </tr>
                       
                        <tr>
                            <th style='width:30%; vertical-align:middle'>Semesters Delivered</th>
                            <td><?=$form->field($outline, 'deliveryperiod')->label('', ['class'=> 'form-label'])->textInput(['maxlength' => true]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Course Provider</th>
                            <td><?=$form->field($outline, 'courseprovider')->label('', ['class'=> 'form-label'])->textInput(['maxlength' => true]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Total Study Hours</th>
                            <td><?=$form->field($outline, 'totalstudyhours')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 5]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Course Description</th>
                            <td><?=$form->field($outline, 'description')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 7]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Course Rationale</th>
                            <td><?=$form->field($outline, 'rational')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 7]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Learning Outcomes</th>
                            <td><?=$form->field($outline, 'outcomes')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 10]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Content</th>
                            <td><?=$form->field($outline, 'content')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 10]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Teaching Methodology</th>
                            <td><?=$form->field($outline, 'teachingmethod')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 3]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Assessment Method</th>
                            <td><?=$form->field($outline, 'assessmentmethod')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 12]);?></td>
                       </tr>

                       <tr>
                            <th style='width:30%; vertical-align:middle'>Learning Resources</th>
                            <td><?=$form->field($outline, 'resources')->label('', ['class'=> 'form-label'])->textArea(['maxlength' => true, 'rows' => 12]);?></td>
                       </tr>
                    </table>
