...
//                                    'action' => Url::to(['register-student/enroll-student']),
                        ...
                        ?>
                            ...
                            <div class="form-group"><br/>
                                <?=Html::a(' Cancel',['profile/student-profile', 'personid' => $user->personid, 'studentregistrationid' => $studentregistrationid], ['class' => 'btn btn-block btn-lg btn-danger glyphicon glyphicon-remove-circle pull-left', 'style' => 'width:25%; margin-left:15%;']);?>
