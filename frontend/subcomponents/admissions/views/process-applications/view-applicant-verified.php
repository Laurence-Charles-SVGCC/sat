    ...
    <div class="box-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class='active' role="presentation">
                ...
                aria-controls="academic-qualifications" role="tab"
                data-toggle="tab">
            ...
            <li role="presentation">
                ...
                aria-controls="personal-information" role="tab"
                data-toggle="tab">
            ...
            <?php if ($applicant->applicantintentid == 4)://if DTE Applicant?>
              <li role="presentation">
                  <a href="#dte-additional-details"
                  aria-controls="dte-additional-details"
            ...
            <?php if ($applicant->applicantintentid == 6)://if DNE Applicant?>
              <li role="presentation">
                  <a href="#dne-additional-details"
                  aria-controls="dne-additional-details"
                  role="tab" data-toggle="tab">
                      Additional Details
                  </a>
              </li>
