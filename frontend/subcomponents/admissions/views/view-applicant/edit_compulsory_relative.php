...
<div class="box box-primary" style="font-size:1.1em">
    ...
    <?php $form = ActiveForm::begin();?>
        <div class="box-body">
            ...
            <div class="form-group">
               <label class="control-label col-xs-6 col-sm-5 col-md-5 col-lg-3" for="relationdetail">Relation Type:</label>
               <?= $form->field($relative, 'relationdetail')->label('')->dropDownList($compulsory_relations, ["class" => "no-padding col-xs-6 col-sm-7 col-md-7 col-lg-9"]);?> 
            </div>
        </div>
