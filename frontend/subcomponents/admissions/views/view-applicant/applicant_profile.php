            ...
            <div role="tabpanel" class="tab-pane fade in active" id="personal_information"> 
                ...
                <?php if(Yii::$app->user->can('ViewProfileData') || Yii::$app->user->can('viewContactDetails')):?>     
                    ...
                    <?php if(Yii::$app->user->can('editContactDetails')):?>
                        <a class="btn btn-info glyphicon glyphicon-pencil pull-right" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-contact-details', 'personid' => $applicant->personid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                    <?php endif;?>
                    </div>
                    <!-- Table -->
                    <table class="table table-hover" style="margin: 0 auto;">
                ...
                <?php if(Yii::$app->user->can('ViewProfileData') || Yii::$app->user->can('viewAddresses')):?>     
                    ...
                    <?php if(Yii::$app->user->can('editAddresses')):?>
                        <a class="btn btn-info glyphicon glyphicon-pencil pull-right" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-addresses', 'personid' => $applicant->personid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                    <?php endif;?>
                    </div>
                    <!-- Table -->
                    <table class="table table-hover" style="margin: 0 auto;">
                ...
                <?php if(Yii::$app->user->can('ViewProfileData') || Yii::$app->user->can('viewRelatives')):?>     
                    ...
                    <?php if(Yii::$app->user->can('addRelative')):?>
                        <a class="btn btn-success glyphicon glyphicon glyphicon-plus pull-right" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/add-optional-relative', 'personid' => $applicant->personid, 'search_status' => $search_status]);?> role="button"> Add</a>
                    <?php endif;?>
                    </div>
                                ...
                                <th rowspan="4" style="vertical-align:top; text-align:center; font-size:1.2em;">Beneficiary
                                    <div style="margin-top:20px">
                                        <?php if(Yii::$app->user->can('editRelatives')):?>
                                            <div >
                                                <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $old_beneficiary->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                            </div>
                                        <?php endif;?> 
                                    </div>
                                </th>
                                ...
                                <th rowspan="4" style="vertical-align:middle; text-align:center; font-size:1.2em;">Beneficiary
                                    <?php if(Yii::$app->user->can('editRelatives')):?>    
                                        <div style="margin-top:40px">
                                            <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-compulsory-relative', 'personid' => $applicant->personid, 'recordid' => $new_beneficiary->compulsoryrelationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                        </div>
                                    <?php endif;?>    
                                </th>
                                <th>Full Name</th>
                            ...
                            <tr>
                                <th rowspan="4" style="vertical-align:middle; text-align:center; font-size:1.2em;">Emergency Contact
                                    <div style="margin-top:20px">
                                        <?php if(Yii::$app->user->can('editRelatives')):?>
                                            <div >
                                                <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $old_emergencycontact->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                            </div>
                                        <?php endif;?>
                                    </div>
                                </th>
                        ...
                        <?php if ($new_emergencycontact!= false):?>
                            <tr>
                                <th rowspan="4" style="vertical-align:middle; text-align:center; font-size:1.2em;">Emergency Contact
                                    <?php if(Yii::$app->user->can('editRelatives')):?>
                                        <div style="margin-top:40px">
                                            <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-compulsory-relative', 'personid' => $applicant->personid, 'recordid' => $new_emergencycontact->compulsoryrelationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                        </div>
                                    <?php endif;?>
                                </th>
                                <th>Full Name</th>
                            ...
                            <tr>
                                <th rowspan="4" style="vertical-align:middle; text-align:center; font-size:1.2em;">Spouse
                                    <div style="margin-top:20px">
                                        <?php if(Yii::$app->user->can('editRelatives')):?>    
                                            <div >
                                                <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $spouse->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                            </div>
                                        <?php endif;?>    
                                        <?php if(Yii::$app->user->can('deleteRelative')):?>
                                            <div style="margin-top:10px">
                                                <?=Html::a(' Delete', 
                                                            ['view-applicant/delete-optional-relative', 'personid' => $applicant->personid, 'recordid' => $spouse->relationid, 'search_status' => $search_status], 
                        ...
                        <?php if ($mother!= false):?>
                            <tr>
                                <th rowspan="4" style="vertical-align:middle; text-align:center; font-size:1.2em;">Mother
                                    ...
                                    <?php if(Yii::$app->user->can('editRelatives')):?> 
                                        <div >
                                            <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $mother->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                        </div>
                                    <?php endif;?>
                                    <?php if(Yii::$app->user->can('deleteRelative')):?> 
                                        <div style="margin-top:10px">
                                            <?=Html::a(' Delete', 
                                                        ['view-applicant/delete-optional-relative', 'personid' => $applicant->personid, 'recordid' => $mother->relationid, 'search_status' => $search_status], 
                                                        ['class' => 'btn btn-danger glyphicon glyphicon-remove',
                                                            'data' => [
                                                                'confirm' => 'Are you sure you want to delete this item?',
                                                                'method' => 'post',
                            ...
                            <tr>
                                <th rowspan="4"  style="vertical-align:middle; text-align:center; font-size:1.2em;">Father
                                    <div style="margin-top:20px">
                                        <?php if(Yii::$app->user->can('editRelatives')):?> 
                                            <div >
                                                <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $father->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                            </div>
                                        <?php endif;?>  
                                        <?php if(Yii::$app->user->can('deleteRelative')):?>     
                                            <div style="margin-top:10px">
                                                <?=Html::a(' Delete', 
                                                            ['view-applicant/delete-optional-relative', 'personid' => $applicant->personid, 'recordid' => $father->relationid, 'search_status' => $search_status], 
                                                            ['class' => 'btn btn-danger glyphicon glyphicon-remove',
                                                                'data' => [
                                                                    'confirm' => 'Are you sure you want to delete this item?',
                                                                    'method' => 'post',
                            ...
                            <tr>
                                <th rowspan="4"  style="vertical-align:middle; text-align:center; font-size:1.2em;">Next of Kin
                                    <div style="margin-top:20px">
                                        <?php if(Yii::$app->user->can('editRelatives')):?> 
                                            <div >
                                                <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $nextofkin->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                            </div>
                                        <?php endif;?>
                                        <?php if(Yii::$app->user->can('deleteRelative')):?> 
                                            <div style="margin-top:10px">
                                                <?=Html::a(' Delete', 
                                                            ['view-applicant/delete-optional-relative', 'personid' => $applicant->personid, 'recordid' => $nextofkin->relationid, 'search_status' => $search_status], 
                                                            ['class' => 'btn btn-danger glyphicon glyphicon-remove',
                                                                'data' => [
                                                                    'confirm' => 'Are you sure you want to delete this item?',
                                                                    'method' => 'post',
                            ...
                            <tr>
                                <th rowspan="4"  style="vertical-align:middle; text-align:center; font-size:1.2em;">Guardian
                                    <div style="margin-top:20px">
                                        <?php if(Yii::$app->user->can('editRelatives')):?> 
                                            <div >
                                                <a class="btn btn-info glyphicon glyphicon-pencil" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-optional-relative', 'personid' => $applicant->personid, 'recordid' => $guardian->relationid, 'search_status' => $search_status]);?> role="button"> Edit</a>
                                            </div>
                                        <?php endif;?>
                                        <?php if(Yii::$app->user->can('deleteRelative')):?>     
                                            <div style="margin-top:10px">
                                                <?=Html::a(' Delete', 
                                                            ['view-applicant/delete-optional-relative', 'personid' => $applicant->personid, 'recordid' => $guardian->relationid, 'search_status' => $search_status], 
                                                            ['class' => 'btn btn-danger glyphicon glyphicon-remove',
                                                                'data' => [
                                                                    'confirm' => 'Are you sure you want to delete this item?',
                                                                    'method' => 'post',
                ...
                <div class="panel panel-default" style="width:95%; margin: 0 auto;">
                    <?php if(Yii::$app->user->can('ViewProfileData') || Yii::$app->user->can('viewGeneral')):?>    
                        ...
                        <?php if(Yii::$app->user->can('editGeneral')):?>        
                            <a class="btn btn-info glyphicon glyphicon-pencil pull-right" href=<?=Url::toRoute(['/subcomponents/admissions/view-applicant/edit-extracurricular', 'personid' => $applicant->personid, 'search_status' => $search_status]);?> role="button"> Edit</a>                                    
                        <?php endif;?>
                        </div>
