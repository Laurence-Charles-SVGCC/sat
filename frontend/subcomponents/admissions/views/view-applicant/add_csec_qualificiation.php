    ...
    <?php $form = ActiveForm::begin();?>
        <div class="box-body">
            ...
            <div class="form-group">
               ...
               <?= $form->field($qualification, 'subjectid')->label('')->dropDownList(['' => 'Select...'], ["class" => "no-padding col-xs-6 col-sm-7 col-md-7 col-lg-9"]) ?>
            </div>
            
            <div class="form-group">
               <label class="control-label col-xs-6 col-sm-5 col-md-5 col-lg-3" for="examinationproficiencytypeid">Proficiency:</label>
               <?= $form->field($qualification, 'examinationproficiencytypeid')->label('')->dropDownList(['' => 'Select...'], ["class" => "no-padding col-xs-6 col-sm-7 col-md-7 col-lg-9"]) ?>
            </div>
            
            <div class="form-group">
               <label class="control-label col-xs-6 col-sm-5 col-md-5 col-lg-3" for="examinationgradeid">Grade:</label>
               <?= $form->field($qualification, 'examinationgradeid')->label('')->dropDownList(['' => 'Select...'], ["class" => "no-padding col-xs-6 col-sm-7 col-md-7 col-lg-9"]) ?>
            </div>
