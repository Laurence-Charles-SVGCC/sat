...
//                                            'class' => 'form-layout'
                        ...
                        echo "<table class='table table-hover' style='width:100%; margin: 0 auto;'>";
                            ...
                            echo "<tr>";
                                ...
                                echo "<td>{$form->field($programme, 'qualificationtypeid')->label('')->dropDownList(ArrayHelper::map(\frontend\models\QualificationType::find()->all(), 'qualificationtypeid', 'name'), ['prompt'=>'Select Qualification Type'])}</td>";
                            echo "</tr>";
