...
//            $temp = NULL;
//        }
//        $qual_limit = count($qualifications);
//        
//        $applicant_model = Applicant::find()
//                        ->where(['personid' => $applicantid, 'isactive' => 1, 'isdeleted' => 0])
//                        ->one();
...
//            
//            
//            $save_new_certificate = $request->post('new_certificate') === '' ? true : false;
//            /*
//             * If action is request to save new certificates
//             */
//            if ($save_new_certificate == true)
//            {
//                Yii::$app->getSession()->setFlash('error', 'Save new record selected');
...
//            
//            /*
//             * If action is not request to save new certificates
//             */
//            else
//            {
//                /*
...
//                }
//
//                $verify_all = $request->post('verify-all') === '' ? true : false;
//
//                $qualifications = CsecQualification::find()
//                            ->where(['personid' => $applicantid, 'isactive' => 1, 'isdeleted' => 0])
//                            ->all();
...
//                else
//                {
//                    /* Removes all the empty generated records.
//                     * Ensures only previously saved records are updates by this operation
//                     */
//                    for ($i=$record_count ; $i<$qual_limit ; $i++)
//                    {
//                        unset($qualifications[$i]);
//                    }
//                    
//                    foreach ($qualifications as $qual)
//                    {
...
//          
//
//        return $this->render('view_applicant_qualifications',
//                [
//                    'csecqualifications' => $qualifications,
//                    'applicant' => $applicant_model,
//                    'username' => $username,
