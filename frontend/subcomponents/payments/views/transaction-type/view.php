         ...
         <div class="custom_body">
            ...
            <table class='table table-hover' style='width:70%; margin: 0 auto;'>
                <tr>
                    ...
                    <td style="vertical-align:middle"><?= $transaction_type->name; ?></td>
                </tr>
                
                <tr>    
                    <th style="width:30%; vertical-align:middle">Creator</th>
                    <td style="vertical-align:middle"><?= Employee::getEmployeeName($transaction_type->createdby); ?></td>
                </tr>
                
                <tr>  
                    <th style="width:30%; vertical-align:middle">Last Modified By</th>
                    <td style="vertical-align:middle"><?= (Employee::getEmployeeName($transaction_type->lastmodifiedby))? Employee::getEmployeeName($transaction_type->lastmodifiedby) : "N/A"; ?></td>
                </tr>
            </table><br/>
        </div>
    </div>
