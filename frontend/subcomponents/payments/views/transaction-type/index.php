    ...
    <div class = "custom_wrapper">
        ...
        <div class="custom_body">
            ...
            <div class="panel panel-default" style="width:95%; margin: 0 auto;">
                <div class="panel-heading" style="color:green;font-weight:bold; font-size:1.3em"> Transaction Types Listing
                    <?php if(Yii::$app->user->can('createTransactionType')):?>
                        <a class="btn btn-success glyphicon glyphicon-plus pull-right" href=<?=Url::to(['configure-transaction-type', 'action' => 'create']);?> role="button"> Create Transaction Type</a>
                    <?php endif;?>
                </div>

                <?php if($dataProvider == false):?>
                    <h3>No transaction types have been created</h3>
                <?php else:?>
                    <br/>
                    <?= GridView::widget([
                                    ...
                                    'buttons' => [
                                        ...
                                        'update' => function ($url, $row) {
                                            return Html::a(
                                                ...
                                                Url::to(['transaction-type/configure-transaction-type', 'action' => 'update', 'id' => $row['id']]),
                                                ['title' => 'Update']
                                               );
                                        },
                                        'toggle' => function ($url, $row) {
                                            if ( $row['active'] == 1)
                                            {
                                                ...
                                                Url::to(['transaction-type/toggle', 'id' => $row['id']]),
                                                ['title' => 'De-activate']
                                               );
                                            }
                                            else
                                        ...
                                        'delete' => function ($url, $row) {
                                            return Html::a(
                                                ...
                                                Url::to(['transaction-type/delete', 'id' => $row['id']]),
                                                ['title' => 'Delete']
                                               );
                                        },
                                    ],
