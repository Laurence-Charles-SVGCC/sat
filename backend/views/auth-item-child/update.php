    ...
    <?php $form = ActiveForm::begin(); ?>
        <div class="box-body">
            <div class="form-group">
               ...
               <?= $form->field($model, 'parent')->label('')->dropDownList(ArrayHelper::map(AuthItem::find()->where(['type' => 1])->all(), 'name', 'name'), ['prompt'=>'Select Parent..', "class" => "no-padding col-xs-6 col-sm-7 col-md-7 col-lg-9", 'disabled' => true]) ?>
            </div>
